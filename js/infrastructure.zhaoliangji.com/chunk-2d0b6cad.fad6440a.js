        ...
        "1f57": function(t, e, r) {
            ...
            (function(e, r) {
                            ...
                            for (var l = 0; l < o; l++)
                                for (var u = 0; u < o; u++) {
                                    var g = t.isDark(l, u),
                                        f = u * n,
                                        d = l * a;
                                    r.strokeStyle = g ? i.colorDark : i.colorLight, r.lineWidth = 1, r.fillStyle = g ? i.colorDark : i.colorLight, r.fillRect(f, d, n, a), r.strokeRect(Math.floor(f) + .5, Math.floor(d) + .5, s, h), r.strokeRect(Math.ceil(f) - .5, Math.ceil(d) - .5, s, h)
                                }
                            this._bIsPainted = !0
                ...
                return i = function(t, e) {
                    ...
                    "string" == typeof t && (t = document.getElementById(t)), this._htOption.useSVG && (_ = p), this._android = c(), this._el = t, this._oQRCode = null, this._oDrawing = new _(this._el, this._htOption), this._htOption.text && this.makeCode(this._htOption.text)
                }, i.prototype.makeCode = function(t) {
                    this._oQRCode = new e(v(t, this._htOption.correctLevel), this._htOption.correctLevel), this._oQRCode.addData(t), this._oQRCode.make(), this._el.title = t, this._oDrawing.draw(this._oQRCode), this.makeImage()
