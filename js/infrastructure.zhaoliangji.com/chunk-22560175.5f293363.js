    ...
    ["chunk-22560175"], {
        ...
        3937: function(e, t, r) {
                ...
                s = function() {
                    ...
                    return r("div", {
                        ...
                        on: {
                            click: function(t) {
                                e.$router.push({
                                    name: "quality-exception-abnormal",
                                    query: {
            ...
            var O = {
                            ...
                            var e = g(c.a.mark((function e(t) {
                                ...
                                return c.a.wrap((function(e) {
                                    while (1) switch (e.prev = e.next) {
                                        ...
                                        case 4:
                                            r = e.sent, this.loading = !1, this.tableData = r.data.data, this.total = r.data.total, this.total_goods_num = r.data.total_goods_num, this.$emit("update:headerTotal", this.total), this.oldSearch.transfer_order_no = f({}, this.search).transfer_order_no, this.oldSearch.imei = f({}, this.search).imei, this.search.transfer_order_no = null, this.search.imei = null;
                                        case 14:
                                        case "end":
                                            return e.stop()
                                    }
                ...
                j = O,
                x = r("5d22"),
                C = Object(x["a"])(j, s, i, !1, null, "5ced9403", null),
                S = C.exports,
                $ = {
                    components: {
                        ListComponent: S
                ...
                L = $,
                P = Object(x["a"])(L, a, n, !1, null, "44250260", null);
            t["default"] = P.exports
        },
        cb97: function(e, t, r) {
            "use strict";
