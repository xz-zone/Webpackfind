(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["chunk-f214021e"], {
        ...
        4634: function(e, t, r) {
            ...
            function n(e) {
                return Object(a["a"])({
                    url: "/api/re_check/transfer_orders",
                    method: "get",
                    params: e
                })
            }
            ...
            function s(e) {
                return Object(a["a"])({
                    url: "/api/re_check/assign_transfer_order",
                    method: "get",
                    params: e
                })
            }
            ...
            function i(e) {
                return Object(a["a"])({
                    url: "/api/re_check/destroy_transfer_order",
                    method: "get",
                    params: e
                })
            }
            ...
            function o(e) {
                return Object(a["a"])({
                    url: "/api/re_check/print_transfer_order",
                    method: "get",
                    params: e
                })
            }
        ...
        "8fa3": function(e, t, r) {
                    ...
                    return r("div", {
                        ...
                        scopedSlots: e._u([{
                            ...
                            fn: function(t) {
                                return [r("div", {
                                    class: {
                                        "color-success": 1 == t.row.receive_status, "color-warning": 0 == t.row.receive_status, "color-danger": -1 == t.row.receive_status
                                    }
            ...
            var k = {
                    ...
                    mounted: function() {
                        this.$refs["transfer_order_no"].focus(), this.search.transfer_order_no = this.$route.query.transfer_order_no, this.isPrint = this.$route.query.print, this.getList(), this.getNodes()
                    },
                    methods: {
                        print: function() {
                            var e = m(c.a.mark((function e() {
                                var t, r;
                                return c.a.wrap((function(e) {
                                    while (1) switch (e.prev = e.next) {
                                        case 0:
                                            return e.prev = 0, t = f(f({}, this.search), {}, {
                                                is_export: 1
                                            }, this.oldSearch), this.printLoading = !0, e.next = 5, Object(l["c"])(t);
                                        case 5:
                        ...
                        getList: function() {
                            var e = m(c.a.mark((function e(t) {
                                var r, a, n, s, i = this;
                                return c.a.wrap((function(e) {
                                    while (1) switch (e.prev = e.next) {
                                        case 0:
                                            return t && (this.search.page = 1), this.loading = !0, e.next = 4, Object(l["c"])(this.search);
                                        case 4:
                                            r = e.sent, this.loading = !1, this.tableData = r.data.data, this.total = r.data.total, this.total_goods_num = r.data.total_goods_num, this.is_disabled = !1, this.selectData = [], a = b(r.data.data);
                                            try {
                                                for (a.s(); !(n = a.n()).done;) s = n.value, this.selectData.push(s.id)
                                            } catch (o) {
                                                a.e(o)
                                            } finally {
                                                a.f()
                                            }
                                            this.isPrint && !this.receiveStatus && (this.isPrint = !1, this.selectRows = r.data.data, this.printOrder(), setTimeout((function() {
                                                i.$refs.printBtn.$el.click()
                                            }), 500)), this.$emit("update:headerTotal", this.total), this.oldSearch.transfer_order_no = f({}, this.search).transfer_order_no, this.search.transfer_order_no = null;
                                        case 17:
                                        case "end":
                                            return e.stop()
                                    }
                        ...
                        openAssign: function(e) {
                            console.log("调用。"), this.orderId = e, this.showAssignDialog = !0
                        },
                        ...
                        destroyOrder: function() {
                            var e = m(c.a.mark((function e(t, r) {
                                return c.a.wrap((function(e) {
                                    while (1) switch (e.prev = e.next) {
                                        case 0:
                        ...
                        printOrder: function() {
                            this.barcodeInfo = [];
                            var e, t = b(this.selectRows);
                            try {
                                for (t.s(); !(e = t.n()).done;) {
                                    var r = e.value;
                                    this.barcodeInfo.push({
                                        code: r.transfer_order_no,
                                        title: r.source_node.name + "---\x3e" + r.to_node.name + "（" + r.area_name.area_name + r.total_num + "台）<br/>" + (new Date).toLocaleString()
                                    })
                                }
                            } catch (a) {
                                t.e(a)
                ...
                O = k,
                j = r("5d22"),
                x = Object(j["a"])(O, s, i, !1, null, "76c09f1d", null),
                C = x.exports,
                $ = {
                    components: {
                        ListComponent: C
                ...
                S = $,
                D = Object(j["a"])(S, a, n, !1, null, "41b3415a", null);
            t["default"] = D.exports
        }
    }
]);