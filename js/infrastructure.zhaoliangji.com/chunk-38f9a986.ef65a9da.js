    ...
    ["chunk-38f9a986"], {
        ...
        db57: function(e, t, r) {
            ...
            var b = {
                    ...
                    methods: {
                        getDetail: function() {
                            var e = m(s.a.mark((function e() {
                                var t, r, n, a, o, c, i, p, d, f, v;
                                return s.a.wrap((function(e) {
                                    while (1) switch (e.prev = e.next) {
                                        ...
                                        case 3:
                                            r = e.sent, this.order = r.data.transfer_order, n = _(r.data.products);
                                            try {
                                                for (n.s(); !(a = n.n()).done;) o = a.value, o.num = 1
                                            } catch (s) {
                                                n.e(s)
                                            } finally {
                                                n.f()
                                            }
                                            this.products = r.data.products, c = _(r.data.abnormal_orders);
                                            try {
                                                for (c.s(); !(i = c.n()).done;) {
                                                    p = i.value, d = _(p.details);
                                                    try {
                                                        for (d.s(); !(f = d.n()).done;) v = f.value, this.exceptionOrder.push(u({
                                                            order_number: p.abnormal_report_order_no,
                ...
                g = b,
                h = (r("6fe9"), r("5d22")),
                y = Object(h["a"])(g, n, a, !1, null, "cce6c394", null);
            t["default"] = y.exports
        }
    }
]);