            ...
            function() {
                if (s_session.searchLogSend == 0) {
                    ...
                    ctx.fire("searchBtnClick", {
                        ...
                        isSkin: !!bds.comm.personalData.fullSkinName.value
                    })
                }
            });
    ...
    function _noskinbind($k) {
        ...
        return function($k, bind) {
            if (!bind) {
                ...
                $k.unbind("focus", emitFo).unbind("blur",
                    emitBl).unbind("mouseover", emitMv).unbind("mouseout", emitMu);
...
F.module("ps/sug", function(require,
    ...
    exports.pssubmit = function() {
        ...
        var isSkin = !!bds.comm.personalData.fullSkinName.value;
        if (satag && $("#kw")[0] && (s_session.searchLogSend == 0 || $(
...
$(document).ready(function() {
    ...
    $(window).bind("load", function() {
        ...
        require([
            ...
            guideTips.init(!!s_session.isLogin)
        });
    ...
    function _initLoadModel() {
        ...
        function mouseEnterHandler() {
            ...
            isLoading = true;
            var cityName = $(
                ".city-wather .show-city-name").attr("data-key");
            if (lastResult) {
